...
The application was first implemented as a **Windows Forms** application, and later a **Console** application was added.  
Basic operations such as adding members and books, borrowing books, and returning books are managed through classes.
---
## Class Structure
